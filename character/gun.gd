...
func _process(delta: float) -> void:
	if can_shoot == true and GunsData.gun_default.magazine > 0 and Input.is_action_just_pressed("shoot"): # за 4 постріли
		fire()
...
func fire():
	GunsData.gun_default.magazine -= 1  # за 4 постріли віднімаємо 1 кулю
